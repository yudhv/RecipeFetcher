...
export const setRecipe = (recipe) => {
    elements.recipe.insertAdjacentHTML('afterbegin',recipeHTML(recipe));
}
...
const ingredientHTML = (ingredients) => ingredients.map(ing => `
...
const recipeHTML = (recipe) => `
    ...
    <div class="recipe__ingredients">
        <ul class="recipe__ingredient-list">
            ${ingredientHTML(recipe.ingredients).join('')}
        </ul>
